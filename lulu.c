 ...
 * mpirun -n 4 ./lulu -da_grid_x 500 -snes_monitor_short -contours  -draw_pause -2   -boundS -ksp_converged_reason -snes_converged_reason -NE -snes_rtol 1.e-6 -ksp_rtol 1.e-8 -ne_snes_rtol 1.e-4 *
 */
/*F-----------------------------------------------------------------------
